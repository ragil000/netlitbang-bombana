            ...
            <div class="card-header border-0">
              <div class="row">
                ...
                <div class="col-lg-10 text-left">
                  <a href="<?=base_url('admin/galry/create/foto-kegiatan')?>" class="btn btn-primary"><i class="ni ni-single-copy-04"></i> Tambah</a>
                </div>
              </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a href="<?=base_url('admin/galry/update/foto-kegiatan/').$value['id']?>" class="btn btn-sm btn-warning"><i class="fa fa-pen"></i></a>
