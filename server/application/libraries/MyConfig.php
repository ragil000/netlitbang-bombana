...
class MyConfig {
    ...
    public function getSession($session, $cekStatus = true, $akun = null, $level = null){
        $status = false;
    ...
    public function setSession($id, $akun, $level, $domain = 1){
        ...
        $encryption = self::$CI->encryption->encrypt($stringSession);
        // print_r($encryption);
        return $encryption;
    }
